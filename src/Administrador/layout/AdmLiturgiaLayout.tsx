...
const ProtectAdmLiturgiaLayout: React.FC<ProtectLayoutProps> = ({ children }) => {
    ...
    useEffect(() => {
      ...
      try {
        ...
        if (decodedPayload.tipo !== 'ADMLITURGIA' && decodedPayload.tipo !== 'ADMGERAL' && decodedPayload.tipo !== 'ADMEVENTOS_CONTEUDOS_E_LITURGIA' && decodedPayload.tipo !== 'ADMEVENTOS_E_LITURGIA' && decodedPayload.tipo !== 'ADMCONTEUDOS_E_LITURGIA') {
        ...
        {showModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
            <div className="bg-white p-5 rounded-lg">
              ...
              <p>Essa rota é protegida e somente administradores de liturgia podem ter acesso a ela.</p>
              <button
  ...
  export default ProtectAdmLiturgiaLayout