...
const ProtectAdmGeralLayout: React.FC<ProtectLayoutProps> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (decodedPayload.tipo !== 'ADMGERAL') {
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
          <div className="bg-white p-5 rounded-lg">
            ...
            <p>Essa rota é protegida e somente administradores gerais podem ter acesso a ela.</p>
            <button
...
export default ProtectAdmGeralLayout;
