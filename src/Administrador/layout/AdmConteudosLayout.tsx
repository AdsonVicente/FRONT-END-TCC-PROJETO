...
const ProtectAdmConteudosLayout: React.FC<ProtectLayoutProps> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (decodedPayload.tipo !== 'ADMCONTEUDOS' && decodedPayload.tipo !== 'ADMGERAL' && decodedPayload.tipo !== 'ADMEVENTOS_E_CONTEUDOS' && decodedPayload.tipo !== 'ADMEVENTOS_CONTEUDOS_E_LITURGIA' && decodedPayload.tipo !== 'ADMCONTEUDOS_E_LITURGIA') {
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
          <div className="bg-white p-5 rounded-lg">
            ...
            <p>Essa rota é protegida e somente administradores de conteudo podem ter acesso a ela.</p>
            <button
