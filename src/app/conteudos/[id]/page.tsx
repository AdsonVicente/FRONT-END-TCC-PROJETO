...
export async function generateMetadata({
  ...
  try {
    ...
    const imageUrl = data.banner?.startsWith("http")
      ? data.banner
      : `https://res.cloudinary.com/dd7vxtdc0/conteudos/${data.banner}`;
    ...
    <div className="container mx-auto py-8 px-4 md:px-8 max-w-5xl relative">
      ...
      <div className="flex justify-center mb-8">
        <Image
          ...
          height={400}
          src={imageUrl}
          alt={`Imagem ilustrativa da notícia: ${stripHtmlTags(
            noticia.titulo
          )}`}
      ...
      <div className="text-sm text-gray-500 text-center">
        Publicado em {formattedDate} — Categoria:{" "}
        <strong>{noticia.categoria.nome}</strong>
        <br />
        Autor:{" "}
        <span
          className="font-semibold"
