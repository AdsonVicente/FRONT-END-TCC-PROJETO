  ...
  return (
    <div className="bg-gray-100 py-10 px-4 min-h-screen flex justify-center">
      <div className="bg-white shadow-lg rounded-xl p-8 max-w-4xl w-full">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Missão e Carisma</h2>
          <p className="text-gray-700 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Trabalhos e Ações</h2>
          <ul className="list-disc list-inside text-gray-700 leading-relaxed">
            ...
            <li className="mb-2">
              ...
              sociais que incluem:
              <ul className="list-inside list-disc ml-6 mt-2">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Onde Atuamos</h2>
          <p className="text-gray-700 leading-relaxed">
