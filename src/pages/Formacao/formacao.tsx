...
const categoryColors: { [key: string]: string } = {
  cursos: "text-blue-400",
  workshops: "text-green-500",
  seminarios: "text-purple-500",
  formacao: "text-yellow-400",
  palestras: "text-red-500",
};
...
const Formacao: React.FC = () => {
  ...
  // Função para buscar categorias e conteúdos
  const fetchData = async () => {
    ...
    try {
      ...
      const filteredConteudos = conteudosResponse.data.filter(
        (conteudo) =>
          [
            "formação",
            "santos e martires",
            ...
            "musica",
          ].includes(conteudo.categoria.nome.toLowerCase()) // Converte o nome da categoria para minúsculas
      );
  ...
  // Filtrar dados com base no termo de pesquisa e categorias selecionadas
  useEffect(() => {
    const filterData = () => {
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:space-x-4">
              <div className="relative">
                <button
                  ...
                  className="flex items-center lg:text-lg px-4 py-2 rounded-md text-sm font-medium  text-black  focus:outline-none focus:ring-2 focus:ring-red-500"
                >
                  Categorias
                  <svg
          ...
          {currentItems.map((item) => (
            ...
            >
              ...
              <div className="mt-2 flex flex-col flex-grow">
                ...
                <h3 className="text-lg font-semibold mb-2 hover:text-red-500">
